...
export const personalInfo = {
  ...
  title: {
    ...
    sq: "Inxhiniere Softuerike & Zhvilluese Web",
...
export const navLinks = [
  { 
    name: { en: "Home", sq: "Ballina", tr: "Anasayfa" }, 
    href: "#home" 
  },
  { 
    name: { en: "Projects", sq: "Projektet", tr: "Projeler" }, 
    href: "#projects" 
  },
  { 
    name: { en: "Experience", sq: "Eksperienca", tr: "Deneyim" }, 
    href: "#experience" 
  },
];
...
export const projects = [
  {
    title: {
      ...
      sq: "Sistemi i Menaxhimit të Inventarit",
    ...
    description: {
      ...
      sq: "Një sistem modern i menaxhimit të inventarit i ndërtuar me Next.js dhe Supabase. Ofron gjurmim të stokut në kohë reale me një panel dinamik (grafikë), izolim të të dhënave sipas roleve (Admin/Staf) përmes Row Level Security (RLS), dhe njoftime automatike për stokun e ulët.",
  ...
  },
  {
    ...
    description: {
      ...
      sq: "Një platformë profesionale full-stack për menaxhimin e projekteve e ndërtuar me MERN stack. Përfshin autentikim të sigurt me JWT për hapësirat private të punës, operacione CRUD në kohë reale, gjurmim të etapave (milestones), dhe një ndërfaqe moderne dark-mode me dizajnin glassmorphism.",
  ...
  },
  {
    ...
    description: {
      ...
      sq: "Një platformë e automatizimit të marketingut e fuqizuar nga inteligjenca artificiale, e ndërtuar me Next.js dhe Supabase. Ka të integruar OpenAI për të gjeneruar plane gjithëpërfshirëse për mediat sociale, mbishkrime (captions) dhe asete vizuale bazuar në të dhënat e biznesit.",
  ...
  },
  {
    title: {
      ...
      sq: "MedSearch - Menaxheri Mobil i Medikamenteve",
    ...
    description: {
      ...
      sq: "Aplikacion cross-platform duke përdorur React Native dhe Supabase që integron OpenFDA API për të ofruar të dhëna për medikamentet në kohë reale dhe menaxhimin e orarit personal.",
  ...
  },
  {
    ...
    description: {
      ...
      sq: "Një aplikacion mobil i ndërtuar me React Native dhe Expo për gjurmimin e shpenzimeve ditore. Karakteristikat përfshijnë vizualizimin e të dhënave përmes grafikëve dhe filtrimit në bazë të kategorive.",
...
export const experience = [
  {
    ...
    description: {
      ...
      sq: "Ligjërova për nxënësit nga klasa e 3-të deri në klasën e 9-të me fokus në kodimin praktik dhe projekte reale. Udhëhoqa klasën drejt ndërtimit të një projekti konkret në JavaScript.",
